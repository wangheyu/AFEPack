/*=============================================================================
#     FileName: recthexa.2.D.bas_fun.c
#         Desc: 
#       Author: Tiao Lu
#        Email: tlu@math.pku.edu.cn
#     HomePage: http://dsec.pku.edu.cn/~tlu
#      Version: 0.0.1
#   LastChange: 2014-08-13 20:41:28
#      History:
=============================================================================*/
...
void gradient_lambda_8(const double * p, const double ** v, void * value)
{
	...
	DEFINE_LV_
	double grad[3];
	grad[0] = DL1(lp[0])*L1(lp[1]);
	grad[1] = L1(lp[0])*DL1(lp[1]);
	grad[2] = 0.;
	DEFINE_PARTIAL_
}
void gradient_lambda_9(const double * p, const double ** v, void * value)
{
	...
	double grad[3];
	grad[0] = 0.;
	grad[1] = DL1(lp[1])*L1(lp[2]); 
	grad[2] = L1(lp[1])*DL1(lp[2]);
...
void gradient_lambda_10(const double * p, const double ** v, void * value)
{
	...
	DEFINE_LV_
	double grad[3];
	grad[0] = L1(lp[2])*DL1(lp[0]);
	grad[1] = 0.;
	grad[2] = DL1(lp[2])*L1(lp[0]);

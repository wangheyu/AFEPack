...
#include <AFEPack/HGeometry.templates.h>
...
#include <AFEPack/HGeometry.templates.nd.h>

template <> HGeometry<0,DOW> * HGeometry<0,DOW>::parent = nullptr;
template <> std::vector<HGeometry<0,DOW> *> HGeometry<0,DOW>::vertex(1, (HGeometry<0,DOW> *)nullptr);
template <> std::vector<HGeometry<0,DOW> *> HGeometry<0,DOW>::boundary(1, (HGeometry<0,DOW> *)nullptr);
template <> std::vector<HGeometry<0,DOW> *> HGeometry<0,DOW>::child(1, (HGeometry<0,DOW> *)nullptr);

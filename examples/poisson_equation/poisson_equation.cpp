...
int main(int argc, char * argv[])
{
  ...
  BoundaryFunction<double,2> boundary1(BoundaryConditionInfo::DIRICHLET, 1, &u);
  BoundaryFunction<double,2> boundary2(BoundaryConditionInfo::DIRICHLET, 2, &u);
  BoundaryFunction<double,2> boundary3(BoundaryConditionInfo::DIRICHLET, 3, &u);
  BoundaryFunction<double,2> boundary4(BoundaryConditionInfo::DIRICHLET, 4, &u);

/**
 * @file stokes_driven_cavity_schur_mesh_sweep_afepack.cpp
...
namespace
{
  ...
  struct CavitySchurMeshSweepRow
  {
    CavitySchurMeshCase mesh_case;
    StokesResult        result;
  };

  std::vector<CavitySchurMeshCase> default_mesh_cases()
  {
    ...
    return {{"unit_square_h0p20",
             ...
             output_dir + "/stokes_driven_cavity_schur_mesh_sweep_h0p20",
             0.20},
            {"unit_square_h0p10",
             mesh_dir + "/unit_square_h0p10",
             output_dir + "/stokes_driven_cavity_schur_mesh_sweep_h0p10",
             0.10}};
  }
  ...
  void print_result_row(const CavitySchurMeshSweepRow &row)
  {
  ...
  try
    {
      ...
      std::vector<CavitySchurMeshSweepRow> rows;

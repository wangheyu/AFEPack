/**
 * @file navier_stokes_contracting_channel_fine_afepack.cpp
...
namespace
{
  ...
  ContractingFineCase default_mesh_case()
  {
    ...
    return {"contracting_channel_h0p125",
            ...
            output_dir + "/navier_stokes_contracting_channel_fine_h0p125",
            0.125};
  }
  ...
  void print_result_row(const ContractingNSFineRow &row)
  {
  ...
  try
    {
      ...
      std::cout << "AFEPack Navier-Stokes contracting-channel fine grid "
                   "(book Exercise 7.6 proxy)\n";

/**
 * @file stokes_step_flow_schur_mesh_sweep_afepack.cpp
...
namespace
{
  ...
  std::vector<StepFlowSchurMeshCase> default_mesh_cases()
  {
    ...
    return {{"step_channel_h0p50",
             ...
             output_dir + "/stokes_step_flow_schur_mesh_sweep_h0p50",
             0.50},
            {"step_channel_h0p25",
             mesh_dir + "/step_channel_h0p25",
             output_dir + "/stokes_step_flow_schur_mesh_sweep_h0p25",
             0.25}};
  }
  ...
  try
    {
      ...
      std::cout << "AFEPack Stokes step-flow Schur/AMG mesh sweep "

/**
 * @file navier_stokes_picard_afepack.cpp
 * @brief AFEPack 不可压 Navier-Stokes 方程算例：Picard 线性化。
 *
 * @details
  ...
  try
    {
      ...
      std::cout << "AFEPack Navier-Stokes Picard Taylor-Hood "

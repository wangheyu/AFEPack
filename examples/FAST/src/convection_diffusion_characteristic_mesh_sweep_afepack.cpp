/**
 * @file convection_diffusion_characteristic_mesh_sweep_afepack.cpp
...
namespace
{
  ...
  struct CharacteristicMeshSweepRow
  {
    CharacteristicMeshCase mesh_case;
    CaseResult             result;
  };

  std::vector<CharacteristicMeshCase> default_mesh_cases()
  {
  ...
  void print_result_row(const CharacteristicMeshSweepRow &row)
  {
...
int main(int argc, char **argv)
{
  ...
  try
    {
      std::vector<CharacteristicMeshSweepRow> rows;
      ...
      std::cout << "AFEPack convection-diffusion characteristic "
                   "boundary-layer mesh sweep (book Example 3.1.2)\n";

/**
 * @file stokes_colliding_schur_mesh_sweep_afepack.cpp
...
namespace
{
  ...
  struct CollidingSchurMeshSweepRow
  {
    CollidingSchurMeshCase mesh_case;
    StokesResult           result;
  };

  std::vector<CollidingSchurMeshCase> default_mesh_cases()
  {
    ...
    return {{"unit_square_h0p20",
             ...
             output_dir + "/stokes_colliding_schur_mesh_sweep_h0p20",
             0.20},
            {"unit_square_h0p10",
             mesh_dir + "/unit_square_h0p10",
             output_dir + "/stokes_colliding_schur_mesh_sweep_h0p10",
             0.10}};
  }
  ...
  void print_result_row(const CollidingSchurMeshSweepRow &row)
  {
  ...
  try
    {
      ...
      std::vector<CollidingSchurMeshSweepRow> rows;
      ...
      std::cout << "AFEPack Stokes colliding-flow Schur/AMG mesh sweep "
                   "(book Example 5.1.4)\n";

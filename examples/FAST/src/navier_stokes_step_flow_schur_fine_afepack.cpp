/**
 * @file navier_stokes_step_flow_schur_fine_afepack.cpp
...
namespace
{
  ...
  FineStepFlowCase default_mesh_case()
  {
    ...
    return {"step_channel_h0p125",
            ...
            output_dir + "/navier_stokes_step_flow_schur_fine_h0p125",
            0.125};
  }
  ...
  try
    {
      ...
      std::cout << "AFEPack Navier-Stokes expansion step-flow fine-grid "
                   "Schur/AMG check (book Example 7.1.2 and Exercise 7.5)\n";

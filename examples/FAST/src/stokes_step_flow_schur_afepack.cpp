/**
 * @file stokes_step_flow_schur_afepack.cpp
        ...
        case PreconditionerKind::schur_mass_amg2:
          {
            ...
            apply_homogeneous_step_dirichlet_boundary(
              velocity_stiffness,
	  ...
	  const std::string output_prefix =
	    argc > 2 ? argv[2] :
	               std::string(AFEPACK_DEFAULT_OUTPUT_DIR) +
	                 "/stokes_step_flow_schur_afepack";
	  ...
	  try
	    {
	      ...
	      std::cout << "AFEPack Stokes step-flow Schur/AMG block "
	      ...
	      std::cout << "preconditioner cells velocity_dofs pressure_dofs "
	                   ...
	                   "velocity_H1 max_speed inflow outflow flux_error "

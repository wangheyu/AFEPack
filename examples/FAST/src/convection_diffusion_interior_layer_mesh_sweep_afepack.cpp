/**
 * @file convection_diffusion_interior_layer_mesh_sweep_afepack.cpp
...
namespace
{
  ...
  struct InteriorMeshSweepRow
  {
    InteriorMeshCase mesh_case;
    CaseResult       result;
  };

  std::vector<InteriorMeshCase> default_mesh_cases()
  {
  ...
  void print_result_row(const InteriorMeshSweepRow &row)
  {
...
int main(int argc, char **argv)
{
  ...
  try
    {
      std::vector<InteriorMeshSweepRow> rows;
      ...
      std::cout << "AFEPack convection-diffusion interior/downstream "
                   "layer mesh sweep (book Example 3.1.3)\n";

/**
 * @file oseen_block_pcd_iterative_viscosity_sweep_afepack.cpp
...
#define main oseen_block_pcd_iterative_afepack_main
#include "oseen_block_pcd_iterative_afepack.cpp"
#undef main
  ...
  const std::string output_prefix =
    argc > 2 ? argv[2] :
               std::string(AFEPACK_DEFAULT_OUTPUT_DIR) +
                 "/oseen_block_pcd_iterative_viscosity_sweep_afepack";
